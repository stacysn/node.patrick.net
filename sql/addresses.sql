create table addresses (
    ...
    address_author        bigint(20) unsigned not null,
    ...
    address_comment_count bigint(20) unsigned not null default 0,
    address_views         bigint(20) unsigned not null default 0,
