    ...
    <div id='footer' >
        <center>
            ...
            <form action='https://www.paypal.com/cgi-bin/webscr' method='post'>
                ...
                <input type='submit' name='submit' value='Donate to support this site (Paypal)'>
            ...
            <br>
            Or you can donate in bitcoin (click or scan the QR code):<br>
            <a href="bitcoin:1CrrUoajUnkLyKqzfkVHAx3WWDgde5UVWg"><img src='/images/pnet_bitcoin_qr_code.png'></a>
        </center>
        ${nav()}
        ${like_dislike()}
    </div>`
